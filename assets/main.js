...
(function() {
	...
	// Timer.
		...
		*/
		...
		timer.prototype.updateSize = function() {
			...
			$symbols = document.querySelectorAll('#' + this.$timer.id + ' > ul > li.delimiter > .symbol');
			$components = document.querySelectorAll('#' + this.$timer.id + ' > ul > li.number > .item > .digit > .component');
			h = 0;
			f = 0;
				...
				// Same status as before? Do a quick update.
					if (status == this.status) {
						...
						for (i = 0; i < x.length; i++) {
							...
							$digit = document.querySelector('#' + this.id + ' > ul > li.number.' + x[i].class + ' > .item > .digit');
							$components = document.querySelectorAll('#' + this.id + ' > ul > li.number.' + x[i].class + ' > .item > .digit > .component');
	...
	// Initialize "On Visible" animations.
		onvisible.add('.buttons-component.style-4', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 500, replay: false });
		onvisible.add('.text-component.style-5', { style: 'flip-backward', speed: 1750, intensity: 10, threshold: 3, delay: 250, replay: false });
		onvisible.add('.text-component.style-7', { style: 'fade-down', speed: 1125, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-6', { style: 'fade-down', speed: 1250, intensity: 3, threshold: 3, delay: 500, replay: false });
		onvisible.add('.image-component.style-10', { style: 'zoom-out', speed: 1500, intensity: 10, threshold: 3, delay: 0, replay: false });
		onvisible.add('.image-component.style-8', { style: 'zoom-out', speed: 1500, intensity: 10, threshold: 3, delay: 0, replay: false });
		onvisible.add('.image-component.style-9', { style: 'zoom-out', speed: 1500, intensity: 10, threshold: 3, delay: 0, replay: false });
		onvisible.add('.icons-component.style-1', { style: 'fade-left', speed: 1000, intensity: 2, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.buttons-component.style-2', { style: 'fade-right', speed: 1000, intensity: 5, threshold: 3, delay: 500, stagger: 250, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.image-component.style-11', { style: 'fade-down', speed: 1500, intensity: 10, threshold: 3, delay: 750, replay: false });
		onvisible.add('.text-component.style-8', { style: 'fade-right', speed: 1250, intensity: 10, threshold: 3, delay: 250, replay: false });
		onvisible.add('.text-component.style-9', { style: 'fade-right', speed: 1250, intensity: 3, threshold: 3, delay: 250, replay: false });
		onvisible.add('.buttons-component.style-3', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 500, stagger: 500, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.image-component.style-5', { style: 'fade-left', speed: 1500, intensity: 10, threshold: 3, delay: 750, replay: false });
		onvisible.add('.image-component.style-4', { style: 'fade-left', speed: 1500, intensity: 10, threshold: 3, delay: 750, replay: false });
		onvisible.add('.image-component.style-12', { style: 'fade-left', speed: 1500, intensity: 10, threshold: 3, delay: 750, replay: false });
		onvisible.add('.text-component.style-11', { style: 'fade-down', speed: 1125, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.style-1', { style: 'fade-left', speed: 1000, intensity: 3, threshold: 3, delay: 0, replay: false });
		onvisible.add('.form-component.style-2', { style: 'fade-down', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.form-component.instance-4', { style: 'fade-left', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.form-component.style-1', { style: 'fade-down', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.buttons-component.style-1', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.text-component.style-4', { style: 'fade-down', speed: 1250, intensity: 3, threshold: 3, delay: 500, replay: false });
		onvisible.add('.form-component.instance-2', { style: 'fade-left', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
